  ...
  return (
    <PageLayout maxWidth="max-w-5xl">
      <div className="mb-6 sm:mb-8">
        ...
        <p className="text-muted-foreground text-sm">Buy CDK keys — fulfilled via Telegram</p>
      </div>
                              ...
                              {isActive && (
                                <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                                  <span className="text-xs text-muted-foreground">
                                    {tier.qty} × ${tier.price.toFixed(2)} = <span className="font-semibold text-foreground">${tierTotal}</span>
                                  </span>
            ...
            <CardContent className="p-4 sm:p-5 space-y-4 sm:space-y-5">
              ...
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0">
                  ...
                  <div className="text-xs text-muted-foreground mt-0.5">{selectedPlan.product} · {selectedPlan.duration}</div>
                </div>
                    ...
                    return (
                      ...
                      >
                        {method.isBalance ? (
                          ...
                          <TetherIcon color={method.color} size={22} />
                        )}
                        <div className="min-w-0">
